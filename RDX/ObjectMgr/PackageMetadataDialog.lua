...
function RDXDB.PackageMetadataDialog(pkg)
	...
	ed_authorrealm:SetText(i18n("Author realm"));
	...
	ed_authoremail:SetText(i18n("Author email"));
	...
	ed_authorwebsite:SetText(i18n("Author website"));
	...
	ed_packageversion:SetText(i18n("Package version"));
	...
	ed_comment:SetText(i18n("Comment"));
...
RDXDB.RegisterPackageMenuHandler(function(mnu, pkg, dialog)
	table.insert(mnu, {
		text = i18n("Info Package"), OnClick = function() VFL.poptree:Release(); RDXDB.PackageMetadataDialog(pkg); end
	});
end);