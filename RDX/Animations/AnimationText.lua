...
RDX.RegisterFeature({
	...
	title = i18n("Text: Translation"); category = i18n("Animations");
	multiple = true;
	IsPossible = function(state)
		if not state:Slot("UnitFrame") then return nil; end
		if not state:Slot("Base") then return nil; end
		if not state:Slot("AnimationText") then return nil; end
		return true;
	end;
	ExposeFeature = function(desc, state, errs)
		if not desc then VFL.AddError(errs, i18n("No Descriptor.")); return nil; end
		if not (desc.owner) or (not state:Slot("AGText_" .. desc.owner)) then
			VFL.AddError(errs, i18n("Invalid Animation Group")); return nil;
		end        
		return true;
	end;
	ApplyFeature = function(desc, state)
		local objname = "AniText_" .. desc.name;
		local aname = "AGText_" .. desc.owner;
...
if ]] .. usecdn .. [[ then 
	...
	UIFromDescriptor = function(desc, parent, state)
		...
		local owner = RDXUI.MakeSlotSelectorDropdown(ui, i18n("Animation Group"), state, "AGText_", nil);
		...
		function ui:GetDescriptor()
			...
			return {
				feature = "text_animation_translation"; version = 1;
...
RDX.RegisterFeature({
	...
	title = i18n("Text: Rotation"); category = i18n("Animations");
	multiple = true;
	IsPossible = function(state)
		if not state:Slot("UnitFrame") then return nil; end
		if not state:Slot("Base") then return nil; end
...
if ]] .. usecdn .. [[ then 
	...
	UIFromDescriptor = function(desc, parent, state)
		...
		local owner = RDXUI.MakeSlotSelectorDropdown(ui, i18n("Animation Group"), state, "AGText_");
		if desc and desc.owner then owner:SetSelection(desc.owner); end
		...
		function ui:GetDescriptor()
			...
			return {
				feature = "text_animation_rotation"; version = 1;
				name = name.editBox:GetText();
				owner = owner:GetSelection();
				duration = duration.editBox:GetText();
...
RDX.RegisterFeature({
	...
	title = i18n("Text: Scale"); category = i18n("Animations");
	multiple = true;
	IsPossible = function(state)
		if not state:Slot("UnitFrame") then return nil; end
		if not state:Slot("Base") then return nil; end
...
if ]] .. usecdn .. [[ then 
	...
	UIFromDescriptor = function(desc, parent, state)
		...
		function ui:GetDescriptor()
			...
			return {
				feature = "text_animation_scale"; version = 1;
				name = name.editBox:GetText();
				owner = owner:GetSelection();
				duration = duration.editBox:GetText();
...
RDX.RegisterFeature({
	...
	title = i18n("Text: Alpha"); category = i18n("Animations");
	multiple = true;
	IsPossible = function(state)
		if not state:Slot("UnitFrame") then return nil; end
		if not state:Slot("Base") then return nil; end
...
if ]] .. usecdn .. [[ then 
	...
	UIFromDescriptor = function(desc, parent, state)
		...
		function ui:GetDescriptor()
			...
			return {
				feature = "text_animation_alpha"; version = 1;
				name = name.editBox:GetText();
				owner = owner:GetSelection();
				duration = duration.editBox:GetText();
