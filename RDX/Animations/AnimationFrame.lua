...
RDX.RegisterFeature({
	name = "frame_animation_translation"; version = 1;
	title = i18n("Frame: Translation"); category = i18n("Animations");
	multiple = true;
	IsPossible = function(state)
		if not state:Slot("UnitFrame") then return nil; end
		if not state:Slot("Base") then return nil; end
		if not state:Slot("AnimationFrame") then return nil; end
		return true;
	end;
	ExposeFeature = function(desc, state, errs)
		if not desc then VFL.AddError(errs, i18n("No Descriptor.")); return nil; end
		if not (desc.owner) or (not state:Slot("AGFra_" .. desc.owner)) then
			VFL.AddError(errs, i18n("Invalid Animation Group")); return nil;
		end        
		return true;
	end;
	ApplyFeature = function(desc, state)
		local objname = "AniFra_" .. desc.name;
		local aname = "AGFra_" .. desc.owner;
...
if ]] .. usecdn .. [[ then 
	...
	UIFromDescriptor = function(desc, parent, state)
		...
		name:SetText(i18n("Name")); name:Show();
		if desc and desc.name then name.editBox:SetText(desc.name); else name.editBox:SetText("translation1"); end
		ui:InsertFrame(name);
		
		local owner = RDXUI.MakeSlotSelectorDropdown(ui, i18n("Animation Group"), state, "AGFra_", nil);
		...
		startdelay:SetText(i18n("Start Delay"));
		startdelay:Show();
		...
		enddelay:SetText(i18n("End Delay"));
		enddelay:Show();
		...
		order:SetText(i18n("Animation Order"));
		order:Show();
		...
		chk_usecdn:SetText(i18n("Use Condition"));
		...
		function ui:GetDescriptor()
			...
			return {
				feature = "frame_animation_translation"; version = 1;
...
RDX.RegisterFeature({
	name = "frame_animation_rotation"; version = 1;
	title = i18n("Frame: Rotation"); category = i18n("Animations");
	multiple = true;
	IsPossible = function(state)
		if not state:Slot("UnitFrame") then return nil; end
		if not state:Slot("Base") then return nil; end
...
if ]] .. usecdn .. [[ then 
	...
	UIFromDescriptor = function(desc, parent, state)
		...
		local owner = RDXUI.MakeSlotSelectorDropdown(ui, i18n("Animation Group"), state, "AGFra_");
		if desc and desc.owner then owner:SetSelection(desc.owner); end
		...
		function ui:GetDescriptor()
			...
			return {
				feature = "frame_animation_rotation"; version = 1;
				name = name.editBox:GetText();
				owner = owner:GetSelection();
				duration = duration.editBox:GetText();
...
RDX.RegisterFeature({
	name = "frame_animation_scale"; version = 1;
	title = i18n("Frame: Scale"); category = i18n("Animations");
	multiple = true;
	IsPossible = function(state)
		if not state:Slot("UnitFrame") then return nil; end
		if not state:Slot("Base") then return nil; end
...
if ]] .. usecdn .. [[ then 
	...
	UIFromDescriptor = function(desc, parent, state)
		...
		function ui:GetDescriptor()
			...
			return {
				feature = "frame_animation_scale"; version = 1;
				name = name.editBox:GetText();
				owner = owner:GetSelection();
				duration = duration.editBox:GetText();
...
RDX.RegisterFeature({
	name = "frame_animation_alpha"; version = 1;
	title = i18n("Frame: Alpha"); category = i18n("Animations");
	multiple = true;
	IsPossible = function(state)
		if not state:Slot("UnitFrame") then return nil; end
		if not state:Slot("Base") then return nil; end
...
if ]] .. usecdn .. [[ then 
	...
	UIFromDescriptor = function(desc, parent, state)
		...
		da:SetText(i18n("Change Alpha to"));
		da:Show();
		...
		function ui:GetDescriptor()
			...
			return {
				feature = "frame_animation_alpha"; version = 1;
				name = name.editBox:GetText();
				owner = owner:GetSelection();
				duration = duration.editBox:GetText();
