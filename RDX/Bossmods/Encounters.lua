...
function RDX.ToggleEncounterPane()
	if RDXU.encounter then
		RDX.print(i18n("Bossmod encounter disabled"));
		RDXU.encounter = nil;
		--RDXDK._CloseWindowRDX("desktop_bossmod");
		RDXDK.QueueLockdownAction("desktop_bossmod", RDXDK._CloseWindowRDX);
	else
		RDX.print(i18n("Bossmod encounter enabled"));
		RDXU.encounter = true;
		--RDXDK._OpenWindowRDX("desktop_bossmod");
		RDXDK.QueueLockdownAction("desktop_bossmod", RDXDK._OpenWindowRDX);
	end
end
