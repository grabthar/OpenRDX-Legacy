...
if class == "WARLOCK" then
	RDXEvents:Bind("SPELLS_BUILD_CLASSES", nil, function()
		RDXSS.ClassifySpell(i18n("Detect Lesser Invisibility()"), "Detect Invisibility");
		RDXSS.ClassifySpell(i18n("Detect Invisibility()"), "Detect Invisibility");
		RDXSS.ClassifySpell(i18n("Detect Greater Invisibility()"), "Detect Invisibility");
	end);

	RDXEvents:Bind("SPELLS_BUILD_CATEGORIES", nil, function()
		RDXSS.CategorizeClass(i18n("Shadow Bolt"), "DIRECT");
		RDXSS.CategorizeClass(i18n("Shadow Bolt"), "DAMAGE");
	end);
end
