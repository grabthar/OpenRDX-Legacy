...
--Omni:LoadVersionFromTOC("RDX6_Omniscience");

VFLP.RegisterCategory("RDX Omniscience");
...
--- Main menu glue
--Omni.menu = RDX.Menu:new();
--RDX.RegisterMainMenuEntry("Omniscience", true, function(tree,frame) 
--	Omni.menu:Open(tree, frame); 
--end);
