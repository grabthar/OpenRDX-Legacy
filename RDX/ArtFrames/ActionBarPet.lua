...
for i=1, ]] .. desc.nIcons .. [[ do
	btn = RDXUI.PetActionButton:new(h, abid, mddata_]] .. objname .. [[, ]] .. desc.ButtonSkinOffset .. [[, ]] .. hidebs .. [[, statesString, nbuttons, ]] .. cdtext .. [[, ]] .. cdgfx .. [[, ]] .. cdGfxReverse .. [[, "]] .. cdTxtType .. [[", ]] .. cdHideTxt .. [[, ]] .. desc.cdoffx .. [[, ]] .. desc.cdoffy .. [[, ]] .. showkey .. [[, ]] .. showtooltip .. [[);
	if btn then
...
RDX.RegisterFeature({
	name = "actionbarpet"; version = 1; title = i18n("Action Bar Pet"); category = i18n("Bars");
